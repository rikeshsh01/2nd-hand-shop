                        ...
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    ...
                                    @foreach($profileIndex as $items)
                                     
                                    <a href="javascript:void(0)">
                                        <img src="{{$items->photo}}" alt="profile image" style="max-height:100px; max-width:120px;">
                                            
                                    </a>
                                        <h4 class="text-white mt-2">{{$items->full_name}}</h4>
                                        <h5 class="text-white mt-2">{{$items->email}}</h5>
                                        @endforeach
                                    </div>
