            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Search Results</h4>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table table table-hover table-bordered table-dark">
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-top-0">{!! html_entity_decode($items->details)!!}</th>
                                            ...
                                            <td class="border-top-0">{{$items->updated_at}}</td>
